...
© @teleuploadgdrivebot
Subscribe @mmsubtitlemovie .
"""
    RENAME_403_ERR = "Sorry. You are not permitted to rename this file."
    ABS_TEXT = " Please don't be selfish."
    UPGRADE_TEXT = """@teleuploadgdrivebot Paid Plans
-------
Plan: FREE
...
Please Message from the ID you want plan to be activated 🙏"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "[Please donate me if you find me useful](https://paypal.me/Lordconer)"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. \n[Please donate me if you find me useful.](https://paypal.me/Lordconer)\nUploaded in {} seconds."
...
Send /me to know current plan details"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/ALEN_TL'>@ALEN_TL</a>"
